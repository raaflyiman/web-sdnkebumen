    ...
    <div class="classy-nav-container breakpoint-off">
        ...
        <nav class="classy-navbar justify-content-between" id="cleverNav">
            ...
            <a class="nav-brand" href="/">
                <!-- <img src="{{ asset('img/icons') }}/laravel.jpg" width="50" alt="">  -->
                SD NEGERI KEBUMEN</a>
            ...
            <div class="classy-menu">
                ...
                <div class="classynav">
                    <ul>
                        <li><a href="/" class="{{ Request::is('/') || Request::is('home') ? 'text-primary' : '' }}">Beranda</a></li>
                        <li><a href="{{ route('about') }}" class="{{ Request::is('about') ? 'text-primary' : '' }}">Visi & Misi</a></li>
